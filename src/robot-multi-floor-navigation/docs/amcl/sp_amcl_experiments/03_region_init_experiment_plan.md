...
| **模块C单独实验报告（修正参数后）** | **`docs/amcl/paper_baseline_vs_reloc_criterion.md`**（§7 为正式实验） |
| **模块C方法说明与实验计划** | **`docs/amcl/3_3_3_reloc_criterion_experiment_plan_v3.md`** |
| 模块A工程实现说明 | `docs/amcl/02_region_init_impl.md` |
| 模块C工程实现说明 | `docs/amcl/04_reloc_confidence_criterion_impl.md` |
| 旧实验数据（历史存档） | `docs/amcl/paper_baseline_vs_region_init.md` |
| 模块A批量实验脚本 | `scripts/amcl/run_batch_comparison.sh` |
| **模块C批量实验脚本** | **`scripts/amcl/run_batch_module_c.sh`** |
...
| 模块A实验日志 | `multi_floor_nav/experiment_logs_sp_amcl/` |
| **模块C实验日志（v2正式）** | **`multi_floor_nav/experiment_logs_module_c_v2/`** |
